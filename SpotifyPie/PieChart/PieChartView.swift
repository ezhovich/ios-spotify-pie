...
public struct PieChartView: View {
    ...
    public init(values:[Double], names: [String], formatter: @escaping (Double) -> String, colors: [Color] = [Color.blue, Color.green, Color.orange, Color.brown, Color.red, Color.cyan, Color.mint, Color.pink, Color.cyan, Color.indigo, Color.teal, Color.yellow], backgroundColor: Color = Color(red: 21 / 255, green: 24 / 255, blue: 30 / 255, opacity: 1.0), widthFraction: CGFloat = 0.75, innerRadiusFraction: CGFloat = 0.60){
        self.values = values
        self.names = names
